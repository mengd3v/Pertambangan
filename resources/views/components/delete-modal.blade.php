        ...
        <div class="modal-content border-0">   
            <div class="modal-body p-0">
                <div class="card border-0 p-sm-3 p-2 justify-content-center">
                    ...
                    <p class="font-weight-bold mb-2"> Yakin ingin menghapus data ini ?</p><p class="text-muted "> Data akan dihapus secara permanen</p></div>
                    <div class="card-body px-sm-4 mb-2 pt-1 pb-0"> 
                        ...
                        <div class="col-auto">
                            <a href="" id="confirmButton" class="btn btn-danger px-4">Delete</a>
                        </div>
                    </div>
                    </div>
                </div>  
