                    ...
                    <form action="{{ route('admin.pesanan.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <select name="user_id" id="Pengelola" class="select2 form-control" required>
                                            <option value="" selected disabled>Pengelola</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="deskripsi" id="Deskripsi" class="form-control" required cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <a href="{{ route('admin.pesanan') }}" class="btn btn-outline-primary btn-block">Kembali</a>   
                            </div>
                            <div class="col-6">
